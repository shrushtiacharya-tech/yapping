    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:p-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center my-16">
          <Card className="bg-card/50 border-border/50 group hover:shadow-primary/20 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <CardHeader>
              <div className="mx-auto bg-primary/20 text-primary rounded-full p-3 w-fit group-hover:scale-110 transition-transform">
                <Users className="h-8 w-8" />
              </div>
              <CardTitle className="pt-4 group-hover:text-primary transition-colors">Our Vibe</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-card/50 border-border/50 group hover:shadow-primary/20 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <CardHeader>
              ...
              <CardTitle className="pt-4 group-hover:text-primary transition-colors">Our Mission</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
          ...
          <Card className="bg-card/50 border-border/50 group hover:shadow-primary/20 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <CardHeader>
              ...
              <CardTitle className="pt-4 group-hover:text-primary transition-colors">Our Promise</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
